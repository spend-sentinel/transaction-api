...
test("POST request", async () => {
    ...
    const response = await fetch("http://2a0d:6fc2:4ff2:ad00:1cf0:7057:1f73:92f1:8080/", {
      method: "POST",
      headers: {
...
test("GET request for single item in db", async () => {
    const response = await fetch("http://2a0d:6fc2:4ff2:ad00:1cf0:7057:1f73:92f1:8080/GET_TEST");
...
test("GET request for single item NOT in db", async () => {
    const response = await fetch("http://2a0d:6fc2:4ff2:ad00:1cf0:7057:1f73:92f1:8080/NOT_IN_DATABASE");
...
test("Delete request (in database)", async () => {
    ...
    await fetch("http://2a0d:6fc2:4ff2:ad00:1cf0:7057:1f73:92f1:8080/", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
    ...
    const response = await fetch("http://2a0d:6fc2:4ff2:ad00:1cf0:7057:1f73:92f1:8080/DELETE_TEST", {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
      },
